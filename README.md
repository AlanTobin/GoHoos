...
GoHoos is organized as a small frontend/backend repository.

- `frontend/` contains the Next.js app.
- `backend/` is reserved for future server/API code.
...
Backend code will live in `backend/` when it is added.
